        ...
        <div className="content">
          ...
          <div className="form">
            ...
            <div className="radio-admin">
              ...
              <input type="radio" className="radio-admin2" name="select" value="manager" onChange={e => setValue(e.target.value)} />
              <label className="radio-admin3" for="manager">Manager</label>

              <input type="radio" className="radio-admin2" name="select" value="waiter" onChange={e => setValue(e.target.value)} />
              <label  className="radio-admin3" for="waiter">Waiter</label>

              <input type="radio" className="radio-admin2" name="select" value="cook" onChange={e => setValue(e.target.value)} />
              <label className="radio-admin3" for="cook">Cook</label>
