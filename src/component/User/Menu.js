          ...
          <div className="flex1">
            ...
            <div className="category-cards">
              {this.state.people.map(person => (
                <div key={person._id}>
                  <div className="cardItems1" onClick={() => this.handleClick(person._id)}>
          ...
          <div className="flex2">
            ...
            {this.state.people.map(person => (
              <div key={person._id}>
                ...
                <div className="card-menues" >
                  {person.products.map(data => (
                    <div key={data._id}>
                      <div className="cardItem-menues">
                        <div classname="image" >
                        ...
                        <div className="content-data">
                          ...
                          <div className="flex-second">
                            <div className="priority-set">
                              <button type="button" className="priority-btn11" onClick={this.DecrementCount}>-</button>
                              <div classNam="p-data">Priority : {this.state.priority}</div>
                              <button type="button" className="priority-btn11" onClick={this.incrementCount}>+</button>
                            </div>

                            <div className="Quantity-set">
                              <button type="button" className="Quantity-btn11" onClick={this.DecrementQTY}>-</button>
                              <div className="q-data">Quantity : {this.state.quantity}</div>
                              <button type="button" className="Quantity-btn11" onClick={this.incrementQTY}>+</button>
                            </div>
                          ...
                          <div className="add-cartBtn_set">
                            <button className="addCart1" onClick={this.togglePopup.bind(data)}>Add Ingredients</button>
                            ...
                            <button className="addCart1" onClick={() => this.addCart(data._id, this.state.priority, this.state.quantity, this.state.notes)}>Add to Cart</button>
                          </div>
                ...
                <div key={person._id}>
                  <div className="cardItem-menues">
                    ...
                    <div className="content-data">
                      ...
                      <div className="add-cartBtn_set">
                        <button className="addCart1" onClick={this.togglePopup.bind(person)}>Add Ingredients</button>
                        {this.state.showPopup ?
                          <Popup
                            title={this.state.Title}
                            text='Close Me'
                        ...
                        <button className="addCart1" onClick={() => this.addCart(person._id, this.state.priority, this.state.quantity, this.state.notes)}>Add to Cart</button>
                      </div>
